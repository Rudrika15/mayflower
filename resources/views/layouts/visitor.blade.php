        ...
        <div class="container-fluid">
            <div class="row carousel-dark">
                <div class="col-md-6 mt-5">
                    ...
                    <a class="carousel-control-next" data-bs-target="#carouselExampleControls" data-bs-slide="next" style="text-decoration: none;">
                                ...
                                <div class="card mt-3 mb-5 sectioncard" id="registerForm" style="width: 33rem;">
                                    <div class="row g-0">
                                        <div class="col-md-4 col-sm-4 d-flex justify-content-center">
                                            <img src="{{ asset('assets/images/register.jpg') }}" alt="Responsive image" class="cardimage img-fluid">
                                        </div>
                                            ...
                                            <div class="card-body text-center mt-2 d-grid gap-3">
                                                <form action="{{route('visitor.store')}}" method="post" class="fw-bold register-form d-grid gap-3" id="register-form">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="exampleInputfirstname1" aria-describedby="emailHelp" name="name" placeholder="Enter Name" require>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control required=" name="contactNumber" placeholder="Enter Phone Number*" />
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="exampleCheck1" style="font-size: 10px;">By
                                                            providing the above
                                                    ...
                                                    <div class="form-check d-flex justify-content-start">
                                                        <button type="submit" class="btn btn-secondary btncard align- ">SEND OTP
                                                            &nbsp;&nbsp;
                        ...
                        <div class="carousel-item active">
                            <div class="" style="width: 35rem;">
                                <div class="card mb-5 mt-3 sectioncard" id="loginForm" style="width: 33rem;">
                                    <div class="row g-0">
                                        <div class="col-md-4 col-sm-4 d-flex justify-content-center">
                                            <img src="{{ asset('assets/images/image3.jpg') }}" alt="Responsive image" class="cardimage img-fluid">
                                        </div>
                                        <div class="col-md-8 col-md-8 d-flex justify-content-center">
                                            <div class="card-body text-center mt-3">
                                                <form action="" class="fw-bold login-form d-grid gap-3" id="login-form">

                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="exampleInputfirstname1" aria-describedby="emailHelp" placeholder="Phone Number">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                                            <label class="form-check-label" for="exampleCheck1" style="font-size: 10px;">By providing the
                                                                above
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button type="button" class="btn btn-secondary btncard align- ">SEND
                                                                    OTP
                                                                    &nbsp;&nbsp;
                                                                    <i class="bi bi-check-circle  push-right"></i></button>
                                                            </div>
