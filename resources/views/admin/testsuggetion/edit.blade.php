...
@endif
    <div class="box-content card danger">
        ...
        <div class="card-content">
            <form action="{{ route('admin.testsuggetion.update') }}" method="POST">
                @csrf
                <input type="hidden" name="id" id="id" value="{{ $testsuggetion->id }}">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-sm form-control" aria-label=".form-select-sm example"
                                ...
                                <option value="{{ $master->id }}"
                                    {{ $master->id == $testsuggetion->masterId ? 'selected' : '' }}>
                                    {{ $master->name }}</option>
                            @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control 'data-error'=>'Name Field is required','required'"
                                placeholder="parameter" name="parameter" id="parameter" value="{{$testsuggetion->parameter}}">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Value:</strong>
                            <input type="text" class="form-control" placeholder="value" name="value" id="value" value="{{$testsuggetion->value}}">
                            <div class="help-block with-errors"></div>
                            @error('value')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="opration" name="opration"
                                id="opration" value="{{$testsuggetion->opration}}">
                            <div class="help-block with-errors"></div>
                            @error('opration')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
