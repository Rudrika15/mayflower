        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success btn-sm" href="{{ route('admin.packagedetail.edit', $packagedetailData->id) }}">Edit</a>
                        <a onclick="return myFunction();" class="btn btn-danger btn-sm" href="{{ route('admin.packagedetail.delete', $packagedetailData->id) }}">Delete</a>
