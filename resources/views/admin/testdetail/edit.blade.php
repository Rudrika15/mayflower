...
@section('content')
    ...
    <div class="box-content card">
        ...
        <div class="card-content">
            <form action="{{ route('admin.testdetail.update') }}" method="POST" data-toggle="validator"  enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" id="id" value="{{ $testdetail->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-sm form-control" aria-label=".form-select-sm example"
                                ...
                                <option value="{{ $testData->id }}"
                                    {{ $testData->id == $testdetail->testId ? 'selected' : '' }}>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" data-error='Test Detail Name Field is required' 
                                placeholder="Test Detail Name" name="testDetailName" id="testDetailName" value="{{$testdetail->testDetailName}}">
                            <div class="help-block with-errors"></div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" data-error='Rate Field is required'
                                placeholder="Rate" name="rate" id="rate" value="{{$testdetail->rate}}">
                            <div class="help-block with-errors"></div>
                            @error('rate')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
