...
@section('content')
    ...
    <div class="box-content card danger">
        ...
        <div class="card-content">
            <form action="{{ route('admin.usertestcenter.store') }}" method="POST" data-toggle="validator">
                @csrf
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-sm form-control"
                                data-error='Select Test Center Name Field is required' required
