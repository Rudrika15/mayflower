...
<div class="box-content card">
    ...
    <div class="card-content">
        <form action="{{ route('admin.aboutus.store') }}" method="POST" data-toggle="validator">
            @csrf
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Text:</strong>
                        <textarea id="editor" class="form-control" data-error='Text Name Field is required' required placeholder="Text Name" name="text" id="text"></textarea>
                        <div class="help-block with-errors text-danger">Text Field is require</div>
                        @error('text')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control" id="type" data-error='Center Field is required' required>
                            ...
                            <option value="SubQuote">Sub Quote</option>
                        </select>
