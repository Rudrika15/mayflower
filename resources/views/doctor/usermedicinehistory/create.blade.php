...
@section('content')
    ...
    <div class="box-content card danger">
        ...
        <div class="card-head">
            <div>
                <h4>User Medicine History Create</h4>
            </div>
            <div>
        ...
        <div class="card-content">
            <form action="{{ route('doctor.usermedicinehistory.store') }}" method="POST" data-toggle="validator">
                @csrf
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>User Name:</strong>
                            <select class="form-control" data-error='doctorId Field is required' required name="userId" id="userId" aria-placeholder="Select Doctor Name">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" data-error='Medicine Field is required' required
                                placeholder="Medicine" name="medicine" id="medicine">
                            <div class="help-block with-errors"></div>
                            @error('medicine')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" data-error='Medicine Details Field is required' required
                                placeholder="Medicine Details" name="medicineDetails" id="medicineDetails">
                            <div class="help-block with-errors"></div>
