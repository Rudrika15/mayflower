                                ...
                                <div class="col">
                                    ...
                                    <div class="">Test Suggestions for you
                                        ...
                                        <div class="col text-center mb-3">
                                            <input class="fw-bold ps-5" name="bmi" id="bmi" value="{{ $youare }}" style="border-radius: 15px; background-color: white;">
                                            <!-- <input type="hiddenn" name="bmi" id="bmi" value="{{ $data->id }}"> -->
                                        </div>
                                        @if ($youare == 'You are Underweight')
                                        <dl class="pink-color">
                                            <button type="button" class="black-color" style="border-radius: 15px; background-color: pink;"> Cancer
                                            </button>
                                            <p>- healthy headstart, breast cancer screening</p>
                                            <button type="button" class="black-color" style="border-radius: 15px; background-color: pink;"> Diabetes
                                            </button>
                                            <p>- healthy headstart, PCOS screening</p>
                                            <button type="button" class="black-color" style="border-radius: 15px; background-color: pink;"> Blood
                                                Pressure </button>
                                            <p>- healthy headstart, PCOS screening</p>
                                        </dl>
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    ...
                                    <div class="mt-1 text ">
                                        ...
                                        <label style="font-size: 15px;">
                                            ...
                                            <ul class="mt-2 square">
                                                <li class="bloodsugar">{{$testdetailData->testDetailName }}</li>
                                            </ul>
                                        </label>
                                    </div>
                                    @endforeach
            ...
            <div class="col d-flex justify-content-center">
                <div class=" ourpackagecard6" style="width: 54rem;">
                    <div class="card-body fw-bold text-white fs-6">
                        ...
                        <img src="{{ asset('assets/images/image8.jpg') }}" class="card-img-left img-fluid ourbtnimg" alt="...">
                        <button type="button" class="btn btn-dark ourbtn">Physician</button>
                        <img src="{{ asset('assets/images/image9.jpg') }}" class="card-img-left img-fluid ourbtnimg" alt="...">&nbsp;&nbsp;&nbsp;
