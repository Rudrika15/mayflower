...
<div class="box-content card danger">
    ...
    <div class="card-content">
        ...
        {!! Form::open(array('route' => 'users.store','method'=>'POST','data-toggle'=>'validator')) !!}
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    {!! Form::text('name', null, array('placeholder' => 'Name','class' => 'form-control','data-error'=>'Name Field is required','required')) !!}
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Email:</strong>
                    {!! Form::text('email', null, array('placeholder' => 'Email','class' => 'form-control','data-error'=>'That email address is invalid','required')) !!}
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::select('roles[]',(['0' => 'Select Role'] + $roles),null,['class' => 'form-control','data-error'=>'This Field is required','required','multiple'],[ 0 => [ "disabled" => true ,'selected']]) !!}
