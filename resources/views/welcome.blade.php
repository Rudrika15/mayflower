                ...
                <div class="col-sm-3 col-md-3 nav" id="nav-tab" role="tablist">
                    <nav>
                        ...
                        <div class="d-flex justify-content-start">
                            <button class="mayflower1 nav-link allinonebtn active" id="nav-allinone-tab" data-bs-toggle="tab" data-bs-target="#nav-allinone" type="button" role="tab" aria-controls="nav-allinone" aria-selected="true" data-bs-slide="allinone">{{$package->packageName}}</button>
                        </div>
                        ...
                        <div class="d-flex justify-content-start">
                            <button class="mayflower1 nav-link allinonebtn active" id="nav-allinone-tab" data-bs-toggle="tab" data-bs-target="#nav-allinone" type="button" role="tab" aria-controls="nav-allinone" aria-selected="true" data-bs-slide="allinone">Mayflower all in one</button>
                        </div>
                        <div class="d-flex justify-content-end mt-5">
                            <button class="mayflower2 nav-link allinonebtn" id="nav-fertility-tab" data-bs-toggle="tab" data-bs-target="#nav-fertility" type="button" role="tab" aria-controls="nav-fertility" aria-selected="false" data-bs-slide="fertility">Fertility checkup</button>
                        </div>
