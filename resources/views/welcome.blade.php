                                            ...
                                            <div class="input-container  text-center height p-2">
                                                ...
                                                <nav>
                                                    <div class="nav nav-tabs mb-2" id="nav-tab" role="tablist"
                                                        ...
                                                        <button class="nav-link text-dark feet1 active" id="nav-feet-tab"
                                                            data-bs-toggle="tab" data-bs-target="#nav-feet" type="button"
                                                            role="tab" aria-controls="nav-feet"
                                                            aria-selected="true">Feet</button>
                                                        <button class="nav-link text-dark feet1" id="nav-in-tab"
                                                            data-bs-toggle="tab" data-bs-target="#nav-in" type="button"
                                                            role="tab" aria-controls="nav-in"
                                                            aria-selected="false">In</button>
                                                        <button class="nav-link text-dark feet1" id="nav-cm-tab"
                                                            data-bs-toggle="tab" data-bs-target="#nav-cm" type="button"
                                                            role="tab" aria-controls="nav-cm"
                                                            aria-selected="false">Cm</button>
                                                    </div>
                                                </nav>
                                                <div class="tab-content" id="nav-tabContent">
                                                    <div class="tab-pane fade active show" id="nav-feet" role="tabpanel"
                                                        aria-labelledby="nav-feet-tab">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" class="form-control bg-white border1"
                                                                    placeholder="" aria-label="nav-feet-tab" id="ftHeight"
                                                                    name="ftHeight">feet
                                                            </div>
                                                            <div class="col">
                                                                <input type="text"
                                                                    class="form-control bg-white border1" placeholder=""
                                                                    aria-label="nav-feet-tab" id="inHeight"
                                                                    name="inHeight">in
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="nav-in" role="tabpanel"
                                                        aria-labelledby="nav-in-tab">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text"
                                                                    class="form-control bg-white border1" placeholder=""
                                                                    aria-label="nav-feet-tab" id="inches"
                                                                    name="inches">inches
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="nav-cm" role="tabpanel"
                                                        aria-labelledby="nav-cm-tab">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text"
                                                                    class="form-control bg-white border1" placeholder=""
                                                                    aria-label="nav-feet-tab" id="height"
                                                                    name="height">cm
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-sm-6 familyhistory1">
                                            <div class="input-container  text-start familyhistory p-2">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="col">
                                                        <i class="bi familyicon1 bi-optical-audio-fill"
                                                            id="diabetes"></i>
                                                    ...
                                                    <div class="col">
                                                        <i class="bi familyicon1 bi-piggy-bank-fill"
                                                            id="mentalillness"></i>
                                                    ...
                                                    <div class="spinner-control">
                                                        ...
                                                        <div class="min-max d-flex justify-content-between">
                                                            <input type="button" value="-"
                                                                class="button-minus  mx-1 border-0 fw-bold"
                                                                data-field="age">
                                                            <input type="number" step="1" max=""
                                                                value="1" name="age" id="age"
                                                                class="age-field border-0 fw-bold text-center">
                                                            <input type="button" value="+"
                                                                class="button-plus border-0 fw-bold" data-field="age">
                                                        </div>
                                                ...
                                                <div class="form-group form-spinner mt-3">
                                                    ...
                                                    <div class="min-max d-flex justify-content-between">
                                                        <input type="button" value="-"
                                                            ...
                                                            data-field="weight">
                                                        <input type="number" step="1" max=""
                                                            value="1" name="weight" id="weight"
                                                            class="weight-field border-0 fw-bold text-center">
                                                        <input type="button" value="+"
                                                            class="button-plus border-0 fw-bold" data-field="weight">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-sm-3 col-md-3 nav" id="nav-tab" role="tablist">
                        <nav>
                            <div class="d-flex justify-content-start">
                                <button class="mayflower1 nav-link allinonebtn active" id="nav-allinone-tab"
                                    data-bs-toggle="tab" data-bs-target="#nav-allinone" type="button" role="tab"
                                    aria-controls="nav-allinone" aria-selected="true"  data-bs-slide="allinone">Mayflower all in one</button>
                            </div>
                            <div class="d-flex justify-content-end mt-5">
                                <button class="mayflower2 nav-link allinonebtn" id="nav-fertility-tab"
                                    data-bs-toggle="tab"  data-bs-target="#nav-fertility" type="button" role="tab"
                                    aria-controls="nav-fertility" aria-selected="false" data-bs-slide="fertility">Fertility checkup</button>
                            </div>
                            <div class="d-flex justify-content-start">
                                <button class="mayflower3 nav-link allinonebtn" id="nav-myfirsthealthcheckup-tab"
                                    data-bs-toggle="tab" data-bs-target="#nav-myfirsthealthcheckup" type="button"
                                    role="tab" aria-controls="nav-myfirsthealthcheckup" aria-selected="false">My
                                    first health chackup</button>
                            </div>
                            <div class="d-flex">
                                <button class="mayflower4 nav-link allinonebtn" id="nav-premaritalcounselling-tab"
                                    data-bs-toggle="tab" data-bs-target="#nav-premaritalcounselling" type="button"
                                    role="tab" aria-controls="nav-premaritalcounselling"
                                    aria-selected="false">Pre-marital counselling</button>
                            </div>
                        </nav>
                    </div>

                    <div class="tab-content col-sm-6 col-md-6 mt-2 " id="nav-tabContent">
                        <div class="tab-pane flade active show ms-4" id="nav-allinone" role="tabpanel"
                            aria-labelledby="nav-allinone-tab">
                            <div class="card d-flex justify-content-center section3card pb-5 mb-5 cardall"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 mt-2 cardiconour">
                                        <img src="{{ asset('assets/images/image11.png') }}"
                                            class="card-img-top images1 img-fluid" alt="...">
                        ...
                        <div class="tab-pane fade ms-4" id="nav-fertility" role="tabpanel"
                            aria-labelledby="nav-fertility-tab">
                        ...
                        <div class="tab-pane fade ms-4" id="nav-myfirsthealthcheckup" role="tabpanel"
                            aria-labelledby="nav-myfirsthealthcheckup-tab">
                            <div class="card d-flex justify-content-center section3card pb-5 mb-5" style="width: 25rem;">
                                <div class="row">
                                    <div class="col-9">
                        ...
                        <div class="tab-pane fade ms-4" id="nav-premaritalcounselling" role="tabpanel"
                            aria-labelledby="nav-premaritalcounselling-tab">
                            <div class="card d-flex justify-content-center section3card pb-5 mb-5" style="width: 25rem;">
                                <div class="row">
                                    <div class="col-9">
                        ...
                        <div class="tab-pane fade ms-4" id="nav-menopausal" role="tabpanel"
                            aria-labelledby="nav-menopausal-tab">
                            <div class="card d-flex justify-content-center section3card pb-5 mb-5" style="width: 25rem;">
                                <div class="row">
                                    <div class="col-9">
                        ...
                        <div class="tab-pane fade ms-4" id="nav-screening" role="tabpanel"
                            aria-labelledby="nav-screening-tab">
                            <div class="card d-flex justify-content-center section3card pb-5 mb-5" style="width: 25rem;">
                                <div class="row">
                                    <div class="col-9">
                    ...
                    <div class="col-sm-3 col-md-3 nav" id="nav-tab" role="tablist">
                        <nav>
                            <div class="d-flex justify-content-end">
                                <button class="mayflower5 nav-link allinonebtn" id="nav-pocos-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-pocos" type="button" role="tab" aria-controls="nav-pocos"
                                    aria-selected="false">POCOS Screening</button>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button class="mayflower6 nav-link allinonebtn" id="nav-menopausal-tab"
                                    data-bs-toggle="tab" data-bs-target="#nav-menopausal" type="button" role="tab"
                                    aria-controls="nav-menopausal" aria-selected="false">Menopausal</button>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button class="mayflower7 nav-link allinonebtn" id="nav-screening-tab"
                                    data-bs-toggle="tab" data-bs-target="#nav-screening" type="button" role="tab"
                                    aria-controls="nav-screening" aria-selected="false">Endometriosis Screening</button>
                            </div>
                        </nav>
                    </div>
